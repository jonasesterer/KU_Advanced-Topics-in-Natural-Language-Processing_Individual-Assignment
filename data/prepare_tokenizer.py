...
assert (
    pad_token_id == 0
), f"Expected {pad_token} to have ID 0, but got {pad_token_id}. ID 0 is {tokenizer.id_to_token(0)}."
assert (
    start_token_id == 1
), f"Expected {start_token} to have ID 1, but got {start_token_id}. ID 1 is {tokenizer.id_to_token(1)}."
assert (
    end_token_id == 2
), f"Expected {end_token} to have ID 2, but got {end_token_id}. ID 2 is {tokenizer.id_to_token(2)}."
